...
let datos = [
  { id: 1, nombre: "Juan", apellido: "Del Valle", edad: 25, borrado: false, actualizado: Date.now() },
  { id: 2, nombre: "maria", apellido: "veliz", edad: 19, borrado: false, actualizado: Date.now() },
  { id: 3, nombre: "Estefania", apellido: "Sales", edad: 35, borrado: false, actualizado: Date.now() },
  { id: 4, nombre: "Hector", apellido: "Salinas", edad: 40, borrado: false, actualizado: Date.now() },
  { id: 5, nombre: "maria Jose", apellido: "Catania", edad: 45, borrado: false, actualizado: Date.now() }
];

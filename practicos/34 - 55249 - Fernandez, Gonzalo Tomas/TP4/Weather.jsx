...
// Mapeo del tipo de clima a los iconos de Meteocons
const iconMapping = {
...
function Weather({ data }) {
  ...
  const iconName =  iconMapping[weatherType] || 'clear-day.svg'; // Sino encuentra nada, que ponga dia despejado por defecto
    ...
    <>
      <article>
        ...
        <footer>          
          ...
          <p>Mínima: {temp_min.toFixed(2)}°C / Máxima: {temp_max.toFixed(2)}°C</p>

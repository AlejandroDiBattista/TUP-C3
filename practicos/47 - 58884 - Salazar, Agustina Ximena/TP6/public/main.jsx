function App() {
    ...
    const obtenerInfoUsuario = async () => {
        try {
            ...
            console.log(data);
            if (data.ok) {
                const infoNueva = { mensaje: data.mensaje, nombreUsuario: data.nombreUsuario };
    ...
    return (
        <div className="contenedor-formularios">
            <h1 className="h1-tp6">TP6 - Gestión de sesiones.</h1>
            ...
            {!estadoSesion ? (
                ...
                <div className="contenedor-formularios-seccion-dos">
                    ...
                    <div className="contenedor-botones-usuario-logeado">
                        <button className="btn-ver-info" onClick={obtenerInfoUsuario}>Ver info</button>

...
const ProductosIniciales = [
    { id: 1, producto: 'Coca-Cola', stock: 10, codigo: '438573845' },
    { id: 2, producto: 'Pepsi', stock: 5, codigo: '456657345' },
    { id: 3, producto: 'Monster', stock: 17, codigo: '87967835' },
    { id: 4, producto: 'Torasso', stock: 10, codigo: '124545634' },
    { id: 5, producto: '7up', stock: 15, codigo: '90966587' }
];
...
function Mostrar({ producto, alEditar, alBorrar, incrementarStock }) {
    return (
        <div className="producto">
            <div className="stock">
                <button onClick={() => incrementarStock(producto.id)}>{producto.stock}</button>
            </div>
...
function Inventario({ productos, estaAgregando, productoEditando, alAgregar, alEditar, alGuardar, alCancelar, alBorrar, incrementarStock }) {
...
function App() {
    ...
    const incrementarStock = (id) => {
        let copia = productos.map(c => c.id === id ? { ...c, stock: c.stock + 1 } : c);
        setProductos(copia);
    };

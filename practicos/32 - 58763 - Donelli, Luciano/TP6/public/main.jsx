    ...
    return (
        <div>
            <div className="container">
                <h2>{formMode === 'register' ? 'Registrate' : 'Inicia Sesión'}</h2>
                {!isLoggedIn && (
                    <form onSubmit={handleFormSubmit}>
                        ...
                        <div>
                            <button type="submit">{formMode === 'register' ? 'Registrar' : 'Iniciar Sesión'}</button>
                        </div>
                    </form>
                )}
                {isLoggedIn && (
                    <div className="button-container">
                        ...
                        {showDetails && (
                            <div className="details-container">
                                ...
                                <p>ID de Usuario: {userId}</p> {/* Muestra el ID del usuario */}
                ...
                {!isLoggedIn && (
                    <button onClick={() => changeFormMode(formMode === 'register' ? 'login' : 'register')}>
                        {formMode === 'register' ? 'Form para Log-In' : 'Form para Register'}
                    </button>
                )}
                <p>{alertMessage}</p>
            </div>

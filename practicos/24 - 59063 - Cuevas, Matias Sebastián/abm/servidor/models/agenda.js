  ...
  try {
    ...
    if (cantidad === 0) {
      await contactos.insertMany([
        { nombre: "matias", apellido: "cuevas", telefono: 2124554 },
        { nombre: "mario corral", apellido: "Correa", telefono: 2124554 },
        { nombre: "pedro", apellido: "orellana", telefono: 2124554 },
        { nombre: "juan", apellido: "nuñez", telefono: 2124554 },
      ]);
